...
const commandMap = {
  ...
  'project cost': {
    ...
    requiresText: true,
    usage: 'project cost <project key or name> [year] [month]',
  },
  'project cost total': {
    scriptCommand: 'project-cost',
    requiresText: false,
    usage: 'project cost total [year] [month]',
  },
  'user cost': {
...
const COMMAND_USAGE_TEXT = {
  ...
  'project cost': 'project cost <key_or_name> [year] [month]',
  'project cost total': 'project cost total [year] [month]',
...
const COMMAND_SHORT_DESCRIPTIONS = {
  ...
  'project cost total': 'Shows cost for all active projects, optionally for a specific year or month (with year).',
